...
def saveToFile():
    ...
    numpy.savetxt('../data/Q/' + args.filename + str(i), qmatrix, delimiter='\t')
    numpy.savetxt('../data/M/' + args.filename + str(i), mvector, delimiter='\t')
    numpy.savetxt('../data/mu/' + args.filename + str(i), muvector, delimiter='\t')
    numpy.savetxt('../data/P/' + args.filename + str(i), pvector, delimiter='\t')
...
def parseInfo():
    ...
    parser.add_argument("-N", "--N_instances", type=int, help="number of instances", required=True)
